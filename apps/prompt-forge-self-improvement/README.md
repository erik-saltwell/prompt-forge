...
| `g-eval-factory` | The G-Eval context factory prompt (`templated/_resources/context_factory_prompt.md`). Scenarios under `targets/g_eval_factory/scenarios/{train,holdout}/`; only `train/` enters the optimizer loop. |
