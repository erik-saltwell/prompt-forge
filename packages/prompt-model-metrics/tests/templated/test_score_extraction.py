...
import pytest
from prompt_model_metrics.templated._logprob_scoring import extract_weighted_score
...
def test_low_numeric_mass_logs_warning(caplog: pytest.LogCaptureFixture) -> None:
    ...
    with caplog.at_level("WARNING"):
        extract_weighted_score(response)
