...
def assert_no_errors_from_file(test_file: Path) -> None:
    assert_validation_from_file(test_file, [])


def assert_no_errors_from_string(markdown_text: str) -> None:
    assert_validation_from_string(markdown_text, [])
